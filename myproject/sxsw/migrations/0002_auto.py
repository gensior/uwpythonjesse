...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field attendees on 'Party'
        db.create_table('sxsw_party_attendees', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('party', models.ForeignKey(orm['sxsw.party'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('sxsw_party_attendees', ['party_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field attendees on 'Party'
        db.delete_table('sxsw_party_attendees')
